...
export const VisionStrategy = () => {
    return(
        <div className="Vision-Strategy">
            ...
            <div className="Strategy py-4 py-lg-5">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-12 col-lg-6">
                            <div className="Strategy-data">
                                <h3 className="text-dark mb-4 text-md-end">Strategy</h3>
                                <h2 className="text-dark mb-4 text-md-end">Excellent working relationship</h2>
                                <p className="text-dark mb-4 text-md-end">Creating website and multimedia solutions requires more than just knowledge. A comprehensive understanding of our clients business and the marketplace they operate in enables us to address and meet the clients' objectives.</p>
